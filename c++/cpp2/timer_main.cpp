...
int main(int argc, char** argv)
{
    ...
    timer timer1(0.10, callback, (void *) "hello 1", 1);
    timer timer2(0.10, callback, (void *) "hello 2", 1);
    timer timer3(0.10, callback, (void *) "hello 3", 1);
    timer timer4(0.10, callback, (void *) "hello 4", 1);
    // timer1.timer_start();
    // timer2.timer_start();
